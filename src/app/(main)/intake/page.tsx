                  ...
                  <article key={index} className="rounded-lg border border-slate-200 bg-white overflow-hidden">
                    ...
                    {isExpanded && (
                      <div className="border-t border-slate-100 bg-slate-50/50 p-4 animate-in slide-in-from-top-2 duration-150">
                        ...
                        {index === 2 && <label className="block"><span className="mb-2 block font-semibold">{t("story")}<span className="ml-1 text-red-500">*</span></span><textarea name="story" value={formData.story} onChange={handleInputChange} onBlur={() => handleFieldBlur("story")} rows={6} className={`w-full rounded-lg border p-3 outline-none focus:ring-4 min-h-[120px] ${getFieldError("story") ? "border-red-400 focus:border-red-500 focus:ring-red-100" : "focus:border-teal-500 focus:ring-teal-100"}`} /><span className={`mt-1 block text-xs font-semibold ${formData.story.trim().length >= 30 ? "text-green-600" : "text-slate-400"}`}>{formData.story.length}/30 minimum characters</span>{getFieldError("story") && touchedFields.has("story") && <p className="text-xs font-semibold text-red-600">{getFieldError("story")}</p>}</label>}
...
<div className="mt-5">
            <label className="mb-2 block font-semibold">{t("story")}<span className="ml-1 text-red-500">*</span></label>
              <textarea
              name="story"
              ...
              rows={5}
              className={`w-full rounded-lg border p-3 outline-none focus:ring-4 min-h-[120px] ${getFieldError("story") ? "border-red-400 focus:border-red-500 focus:ring-red-100" : "focus:border-teal-500 focus:ring-teal-100"}`}
                placeholder={t("storyPlaceholder")}
              />
              <span className={`mt-1 block text-xs font-semibold ${formData.story.trim().length >= 30 ? "text-green-600" : "text-slate-400"}`}>{formData.story.length}/30 minimum characters</span>
              {getFieldError("story") && touchedFields.has("story") && <p className="text-xs font-semibold text-red-600">{getFieldError("story")}</p>}
            </div>
